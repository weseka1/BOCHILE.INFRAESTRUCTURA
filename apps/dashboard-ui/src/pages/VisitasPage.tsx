...
import { Phone, MapPin, Clock, User as UserIcon } from 'lucide-react';
      ...
      <div className="mb-6">
        ...
        {solicitudes.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {solicitudes.map((l) => (
              <Card key={l.lead_id} className="border-amber-500/30 hover:border-amber-500/60 transition-colors">
