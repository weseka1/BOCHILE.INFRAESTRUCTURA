// Inspecciona el tool de busqueda + sub-agente matcher + schema de
// propiedades (qué columnas tiene la tabla 'propiedades')
...
(async () => {
  ...
  for (const name of ['Buscar Propiedades en Catalogo', 'SubAgente Matcher']) {
