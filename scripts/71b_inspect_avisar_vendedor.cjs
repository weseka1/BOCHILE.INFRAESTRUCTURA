// Volcar parametros completos de "Avisar Vendedor respond.io" para entender
// su URL actual y como modificarla con condicional es_canal_test.
...
(async () => {
  ...
  const av = w.nodes.find(n => n.name === 'Avisar Vendedor respond.io');
  if (!av) { console.log('No encontre Avisar Vendedor'); return; }
  console.log(JSON.stringify(av.parameters, null, 2));
