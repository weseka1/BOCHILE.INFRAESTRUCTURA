// Reset memoria buffer agregando "_v3" al sessionKey. Esto fuerza sesion nueva
// vacia para Yamil sin tocar el sheet.
...
(async()=>{
  ...
  mem.parameters.sessionKey = "={{ $('Merge Caminos').item.json.telefono }}_v3";
  ...
  const m2 = wf2.nodes.find(n => n.name === 'Memoria Conversacion');
  console.log('sessionKey final:', m2.parameters.sessionKey);
})();
