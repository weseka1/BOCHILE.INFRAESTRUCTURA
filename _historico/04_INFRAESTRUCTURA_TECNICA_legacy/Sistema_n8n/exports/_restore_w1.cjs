// Restaura el workflow W1 desde W1_LATEST.json. Usalo si la UI lo pisa.
...
(async()=>{
  const BACKUP = 'C:/Users/46094/Desktop/WESEKA_IA_STRUCTURE/01_CLIENTES/Bochile/04_INFRAESTRUCTURA_TECNICA/Sistema_n8n/backups/W1_LATEST.json';
  const wf = JSON.parse(fs.readFileSync(BACKUP, 'utf-8'));
  ...
  const r = await req('PUT', '/api/v1/workflows/aUMQyupnGJ5IWm5e', clean);
  console.log('Restore PUT:', r.status);
