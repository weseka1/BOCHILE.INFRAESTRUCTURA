...
(async()=>{
  ...
  console.log('Anterior:', mem.parameters.sessionKey);
  mem.parameters.sessionKey = "={{ $('Merge Caminos').item.json.telefono }}_v5";
  ...
  console.log('Nuevo:', "={{ $('Merge Caminos').item.json.telefono }}_v5");
})();
