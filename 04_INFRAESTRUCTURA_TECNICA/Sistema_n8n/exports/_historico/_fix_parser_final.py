"""Parser fix final: telefono_twilio sin prefijo 'whatsapp:'. El nodo Twilio con toWhatsapp:true lo agrega solo."""
...
print('OK parser sin prefix whatsapp:')
...
for n in w2['nodes']:
    if n['name'] == 'Parsear Mensaje':
        ...
        if "telefono_twilio: send_to" in c:
            print('OK verificado: telefono_twilio = solo +542...sin prefix')
