// Fix Cargar Historial: en lugar de operation 'read' con filtersUI (que falla y
// devuelve la primera tab=leads), usamos 'lookup' explicito que SI respeta el
// sheetName y el lookupColumn.
...
(async()=>{
  ...
  // Reescribir con operation lookup explicito
  ch.parameters = {
    operation: 'lookup',
